...
class Yuzuki:
    ...
    def sign(self):
        ...
        session.post(url, headers=self.headers)
        print('签到成功！')
    ...
    def like(self, comment_id, count):
        url = 'https://www.szhai.me/wp-json/b2/v1/commentVote'
        data = {
            'type': 'comment_up',
...
if __name__ == '__main__':
    ...
    MeiMeng = Yuzuki(username='', password='', root='www.clubmeitu.com', index=26, comment_count=1, follow_count=0)
    Yuzhaizu = Yuzuki(username='', password='', root='www.otakv.co', index=17, comment_count=6, follow_count=2)
    Sizhaiwang = Yuzuki(username='', password='', root='www.szhai.me', index=21, comment_count=6, follow_count=2)

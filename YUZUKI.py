...
if __name__ == '__main__':
    ...
    MeiMeng = Yuzuki(username='username', password='password', root='www.clubmeitu.com', comment_count=3, follow_count=3)
    Yuzhaizu = Yuzuki(username='username', password='password', root='www.otakv.co', comment_count=4, follow_count=2)
    Sizhaiwang = Yuzuki(username='username', password='password', root='www.szhai.me', comment_count=4, follow_count=2)
